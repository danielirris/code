...
export default function ProjectCardMenu({ projectId, projectName, currentStatus }: ProjectCardMenuProps) {
        ...
        {open && (
          <div style={{
            ...
            <button
              ...
              onMouseLeave={e => (e.currentTarget.style.background = "transparent")}
            >
              <Archive size={14} /> {currentStatus === "archived" ? "Reactivar" : "Archivar"}
            </button>
      ...
      {showDeleteModal && (
        ...
        >
          ...
          >
            ...
            <h3 style={{ fontSize: "1.2rem", marginBottom: "0.75rem" }}>¿Eliminar "{projectName}"?</h3>
            <p style={{ color: "var(--text-secondary)", fontSize: "0.9rem", marginBottom: "1.5rem", lineHeight: 1.6 }}>
              Se eliminarán también el historial de entregables y la base de conocimiento asociada. Esta acción no se puede deshacer.
            </p>
