      ...
      <div className="bento-card" style={{ maxWidth: "600px" }}>
        ...
        <form action={saveApiKey} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <div>
            ...
            <select name="selectedModel" className="input-base" defaultValue={settings?.selectedModel || "claude-3-7-sonnet-20250219"}>
              ...
              <option value="claude-3-opus-20240229">Claude 3 Opus (Legado)</option>
            </select>
          </div>
